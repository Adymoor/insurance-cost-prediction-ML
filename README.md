...
```
Training data → Model training → Save model (.pkl)
```
 
**Later:**
```
Saved model → Load model → Prediction
```
 
## 📦 Saving the Model
The trained XGBoost model was stored as `AI_model.pkl`.
...
The trained model is stored as `AI_model.pkl`.
